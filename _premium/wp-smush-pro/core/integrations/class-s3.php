...
class S3 extends Abstract_Integration {
	...
	/**
	 * Check if S3 integration can be activated.
	 *
	 * @return false|bool
	 */
	public function can_active_s3_integration() {
	...
	private function is_active() {
		...
		if ( is_null( $is_active ) ) {
			$is_active = $this->enabled && $this->settings->get( $this->module ) && Membership::get_instance()->is_pro();
		}
		return $is_active;
	}
