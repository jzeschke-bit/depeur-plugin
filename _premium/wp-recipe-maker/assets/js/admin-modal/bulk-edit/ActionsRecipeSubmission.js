...
const ActionsRecipeSubmission = (props) => {
    const selectedAction = props.action ? props.action.type : false;
    const actionOptions = [
        { value: 'approve', label: __wprm( 'Approve' ), default: false },
        { value: 'approve-add-post', label: __wprm( 'Approve & Add to Post' ), default: false },
        { value: 'delete', label: __wprm( 'Delete' ), default: false },
    ];
...
export default ActionsRecipeSubmission;
