...
class WPRM_SC_Text_Share extends WPRM_Template_Shortcode {
	...
	public static function shortcode( $atts ) {
		...
		if ( (bool) $atts['use_in_popup'] ) {
			return '<a href="' . esc_attr( $text_url ) . '" data-recipe="' . esc_attr( $recipe->id() ) . '" class="wprm-recipe-text-share" target="_blank" rel="nofollow"' . $aria_label . '>%wprm_share_placeholder%</a>';
		}
