...
class WPRM_SC_Facebook_Share extends WPRM_Template_Shortcode {
	...
	public static function shortcode( $atts ) {
		...
		if ( (bool) $atts['use_in_popup'] ) {
			return '<a href="' . esc_attr( $share_url ) . '" ' . $facebook_script .' data-recipe="' . esc_attr( $recipe->id() ) . '" class="wprm-recipe-facebook-share" target="_blank" rel="nofollow noopener"' . $aria_label . '>%wprm_share_placeholder%</a>';
		}
