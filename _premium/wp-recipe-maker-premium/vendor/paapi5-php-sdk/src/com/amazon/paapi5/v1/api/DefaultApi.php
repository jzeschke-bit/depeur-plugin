...
namespace BootstrappedVentures\WPRecipeMaker\Amazon\ProductAdvertisingAPI\v1\com\amazon\paapi5\v1\api;

use BootstrappedVentures\WPRecipeMaker\GuzzleHttp\ClientInterface;
use BootstrappedVentures\WPRecipeMaker\GuzzleHttp\Exception\RequestException;
use BootstrappedVentures\WPRecipeMaker\GuzzleHttp\Psr7\MultipartStream;
use BootstrappedVentures\WPRecipeMaker\GuzzleHttp\Psr7\Request;
use BootstrappedVentures\WPRecipeMaker\GuzzleHttp\RequestOptions;
...
use BootstrappedVentures\WPRecipeMaker\Amazon\ProductAdvertisingAPI\v1\HeaderSelector;
use BootstrappedVentures\WPRecipeMaker\Amazon\ProductAdvertisingAPI\v1\ObjectSerializer;
use BootstrappedVentures\WPRecipeMaker\Amazon\ProductAdvertisingAPI\v1\com\amazon\paapi5\v1\auth\SignHelper;
...
class DefaultApi
{
     ...
     *
     * @param  \BootstrappedVentures\WPRecipeMaker\Amazon\ProductAdvertisingAPI\v1\com\amazon\paapi5\v1\GetBrowseNodesRequest $getBrowseNodesRequest GetBrowseNodesRequest (required)
     *
     * @throws \BootstrappedVentures\WPRecipeMaker\Amazon\ProductAdvertisingAPI\v1\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \BootstrappedVentures\WPRecipeMaker\Amazon\ProductAdvertisingAPI\v1\com\amazon\paapi5\v1\GetBrowseNodesResponse
     */
     ...
     * @throws \BootstrappedVentures\WPRecipeMaker\Amazon\ProductAdvertisingAPI\v1\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \BootstrappedVentures\WPRecipeMaker\Amazon\ProductAdvertisingAPI\v1\com\amazon\paapi5\v1\GetBrowseNodesResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getBrowseNodesWithHttpInfo($getBrowseNodesRequest)
    {
        $returnType = '\BootstrappedVentures\WPRecipeMaker\Amazon\ProductAdvertisingAPI\v1\com\amazon\paapi5\v1\GetBrowseNodesResponse';
            ...
            switch ($e->getCode()) {
                case 400:
                    $data = ObjectSerializer::deserialize(
                        $responseBody,
                        '\BootstrappedVentures\WPRecipeMaker\Amazon\ProductAdvertisingAPI\v1\com\amazon\paapi5\v1\ProductAdvertisingAPIClientException',
                ...
                default:
                    $data = ObjectSerializer::deserialize(
                        $responseBody,
                        '\BootstrappedVentures\WPRecipeMaker\Amazon\ProductAdvertisingAPI\v1\com\amazon\paapi5\v1\ProductAdvertisingAPIServiceException',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     *
     * @throws \InvalidArgumentException
     * @return \BootstrappedVentures\WPRecipeMaker\GuzzleHttp\Promise\PromiseInterface
     */
     ...
     *
     * @throws \InvalidArgumentException
     * @return \BootstrappedVentures\WPRecipeMaker\GuzzleHttp\Psr7\Request
     */
    protected function getBrowseNodesRequest($getBrowseNodesRequest)
    {
        ...
        if (isset($_tempBody)) {
            ...
            if ($httpBody instanceof \stdClass && $headers['Content-Type'] === 'application/json') {
                $httpBody = \BootstrappedVentures\WPRecipeMaker\GuzzleHttp\json_encode($httpBody);
            }
            ...
            if ($multipart) {
                ...
                $httpBody = \BootstrappedVentures\WPRecipeMaker\GuzzleHttp\json_encode($formParams);

            } else {
                // for HTTP post (form)
                $httpBody = \BootstrappedVentures\WPRecipeMaker\GuzzleHttp\Psr7\Query::build($formParams);
            }
        }
        ...
        $query = \BootstrappedVentures\WPRecipeMaker\GuzzleHttp\Psr7\Query::build($queryParams);
        return new Request(
            'POST',
     ...
     * Operation getItems
     *
     * @param  \BootstrappedVentures\WPRecipeMaker\Amazon\ProductAdvertisingAPI\v1\com\amazon\paapi5\v1\GetItemsRequest $getItemsRequest GetItemsRequest (required)
     *
     * @throws \BootstrappedVentures\WPRecipeMaker\Amazon\ProductAdvertisingAPI\v1\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \BootstrappedVentures\WPRecipeMaker\Amazon\ProductAdvertisingAPI\v1\com\amazon\paapi5\v1\GetItemsResponse
     */
     ...
     * @throws \BootstrappedVentures\WPRecipeMaker\Amazon\ProductAdvertisingAPI\v1\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \BootstrappedVentures\WPRecipeMaker\Amazon\ProductAdvertisingAPI\v1\com\amazon\paapi5\v1\GetItemsResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getItemsWithHttpInfo($getItemsRequest)
    {
        $returnType = '\BootstrappedVentures\WPRecipeMaker\Amazon\ProductAdvertisingAPI\v1\com\amazon\paapi5\v1\GetItemsResponse';
     ...
     *
     * @param  \BootstrappedVentures\WPRecipeMaker\Amazon\ProductAdvertisingAPI\v1\com\amazon\paapi5\v1\GetVariationsRequest $getVariationsRequest GetVariationsRequest (required)
     *
     * @throws \BootstrappedVentures\WPRecipeMaker\Amazon\ProductAdvertisingAPI\v1\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \BootstrappedVentures\WPRecipeMaker\Amazon\ProductAdvertisingAPI\v1\com\amazon\paapi5\v1\GetVariationsResponse
     */
     ...
     * @throws \BootstrappedVentures\WPRecipeMaker\Amazon\ProductAdvertisingAPI\v1\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \BootstrappedVentures\WPRecipeMaker\Amazon\ProductAdvertisingAPI\v1\com\amazon\paapi5\v1\GetVariationsResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getVariationsWithHttpInfo($getVariationsRequest)
    {
        $returnType = '\BootstrappedVentures\WPRecipeMaker\Amazon\ProductAdvertisingAPI\v1\com\amazon\paapi5\v1\GetVariationsResponse';
     ...
     *
     * @param  \BootstrappedVentures\WPRecipeMaker\Amazon\ProductAdvertisingAPI\v1\com\amazon\paapi5\v1\SearchItemsRequest $searchItemsRequest SearchItemsRequest (required)
     *
     * @throws \BootstrappedVentures\WPRecipeMaker\Amazon\ProductAdvertisingAPI\v1\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \BootstrappedVentures\WPRecipeMaker\Amazon\ProductAdvertisingAPI\v1\com\amazon\paapi5\v1\SearchItemsResponse
     */
     ...
     * @throws \BootstrappedVentures\WPRecipeMaker\Amazon\ProductAdvertisingAPI\v1\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \BootstrappedVentures\WPRecipeMaker\Amazon\ProductAdvertisingAPI\v1\com\amazon\paapi5\v1\SearchItemsResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function searchItemsWithHttpInfo($searchItemsRequest)
    {
        $returnType = '\BootstrappedVentures\WPRecipeMaker\Amazon\ProductAdvertisingAPI\v1\com\amazon\paapi5\v1\SearchItemsResponse';
