...
**Stand: 2026-07-08 (Live-First-Pivot in Umsetzung, Staging alkiplugin.wpentwurf.de). Vier Feature-Module live + getestet, ACF aufgeräumt, neues Wartungs-Modul `acf-cleanup` gebaut. NÄCHSTER: `acf-cleanup` live smoke-testen; danach Live-Cutover-Checkliste alkipedia.com ODER weiter Feature-/Theme-Arbeit (P8).**
