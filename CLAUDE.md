...
**Stand: 2026-06-14 (zehnte Claude-4.8-Session, „h"). P3 BRIEF v1.0 FREIGEGEBEN — Modul heißt `content-types` (umbenannt von `post-type-registry`: Naming-Kollision mit Core-`PostTypeRegistry` an der Wurzel beseitigt, Begründung BRIEF § 3.1). KEIN Code (§ 12.3, BRIEF-Phase). NÄCHSTER: P3 Code-Phase — erster Schritt `config/seed.php` aus dem § 2-Live-Dump.**
